...
# def get_all_users():
#     users = User.query.all()
#     users_data = [{"user_id": user.user_id, "username": user.username, "email": user.email, "contact": user.contact, "is_admin": user.is_admin, "created_at": user.created_at} for user in users]  # Added created_at attribute to the response
#     return jsonify(users_data), 200
...
#         "contact": user.contact,
#         "is_admin": user.is_admin,
#         "created_at": user.created_at  # Added created_at attribute to the response
#     }
#     return jsonify(user_data), 200
